...
@property (nonatomic, strong, nullable) FMDatabase *parentDB;
...
@property (nonatomic, strong, readonly) NSMutableDictionary *columnNameToIndexMap;

/** `FMStatement` used by result set. */

@property (nonatomic, strong, nullable) FMStatement *statement;
